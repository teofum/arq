...
argparse -i 'c/make-c' 'C/main-c' 's/make-asm' 'S/main-asm' -- $argv
...
echo "
$name: $exec_deps $libs
	gcc -g -m32 $exec_deps $libs -o $name" >> Makefile

# Main obj target
if set -ql _flag_S
echo "
$dir_name/main.o: $dir_name/main.s
	nasm -g -F dwarf -f elf32 $dir_name/main.s -o $dir_name/main.o" >> Makefile
else if set -ql _flag_C
echo "
$dir_name/main.o: $dir_name/main.c
	gcc -c -g -F dwarf -m32 $dir_name/main.c -o $dir_name/main.o" >> Makefile
end
...
$dir_name/$name.o: $dir_name/$name.s
	nasm -g -F dwarf -f elf32 $dir_name/$name.s -o $dir_name/$name.o" >> Makefile
else if set -ql _flag_c
echo "
$dir_name/$name.o: $dir_name/$name.c
	gcc -c -g -F dwarf -m32 $dir_name/$name.c -o $dir_name/$name.o" >> Makefile
end
